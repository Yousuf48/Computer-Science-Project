...
training_data = data.DataLoader(hsl_data, batch_size=64,  shuffle=True, num_workers=4)
...
torch.save(colouriastion_faces.state_dict(), "models/hsl_add.pth")
print(f"total time = {(time.time() - total_time)/3600}")
np.save("add_hsl_loss.npy", total_loss)
