...
images_pair = data.DataLoader(pair_datasets_mnist, batch_size=128,num_workers=4 , pin_memory=True,shuffle=True)
...
torch.save(combined_cnn.state_dict(), "models/denosing_mnist.pth")
np.save("denoising_mnist.npy",losses )
